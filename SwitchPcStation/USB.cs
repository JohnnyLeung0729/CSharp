        ...
        public static PnPEntityInfo[] WhoUsbDevice(UInt16 VendorID, UInt16 ProductID, Guid ClassGuid)
        {
            ...
            if (USBControllerDeviceCollection != null)
            {
                ...
                {   // 获取设备实体的DeviceID
                    ...
                    //Console.WriteLine(USBControllerDevice.ToString());
                    Console.WriteLine(USBControllerDevice["Dependent"] as String +"$$$$");
                    String Dep = USBControllerDevice["Dependent"] as String;
                    ...
                    {
                        PnPEntityInfo Element;
                        Element.PNPDeviceID = "";  // 设备ID
                        Element.Name = "";                // 设备名称
                        Element.Description = "";  // 设备描述
                        Element.Service = "";          // 服务
                        Element.Status = "";            // 设备状态
                        Element.VendorID = 0;     // 供应商标识
                        Element.ProductID = 0;   // 产品编号
                        Element.ClassGuid = Guid.NewGuid();   // 设备安装类GUID
                        Element.DeviceID = Dep;
